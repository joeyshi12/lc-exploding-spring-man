...
namespace CreativeMode.Patches
{
    internal class ExplodingSpringManPatch
    {
...
*/
        ...
        {
            SpawnableMapObject mapObj = currentRound.currentLevel.spawnableMapObjects[ExplodingSpringManPatch.mine];
